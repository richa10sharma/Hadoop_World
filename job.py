...
print "here are the IPs of cluster and their names<br>"

fp = open("/etc/cluster/infocluster.txt","r+")
for line in fp:
        print line+"<br>"
print "<br><hr>"
fp.close()
...
<form align ="right" action="http://192.168.43.102/cgi-bin/jobtr.py" method="post">
<br>
Enter the job to be done: <input name='jobn'  type='text' /><br>
	Enter the file to be processed: <input name='filen'  type='text' /><br>
	Enter the output filename : <input name='out' type='text'>	
