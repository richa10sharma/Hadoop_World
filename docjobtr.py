...
#matter=fs.read()|
commands.getstatusoutput("sudo docker exec -i  jt hadoop jar /usr/share/hadoop/hadoop-examples-1.2.1.jar wordcount /"+filename+" /"+outfile)
print ("<br><br>words and their word count are<br><br>")
pr = commands.getstatusoutput("sudo docker exec -i  jt hadoop fs -cat /"+outfile+"/part-r-00000")[1]
print pr
