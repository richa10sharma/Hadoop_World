...
.imgdivs:hover{
   ...
   <div id="intro">
		<form align ="right" action="http://192.168.43.102/cgi-bin/docker.py" method="post">
<br>
<b>--NUMBER OF DATANODES AND TASKTRACKERS YOU WANT--</b><br><br> <input name='nd'  type='text' /><br>
