...
print "---Given below are the HDFS uploads--<br><br>"
nip = commands.getstatusoutput("cat /etc/cluster/infocluster.txt | grep 'nn' | awk '{print $2}'")[1]
lss= commands.getstatusoutput("sudo sshpass -p 123 ssh -l root 192.168.43.150 hadoop fs -ls / ")[1]
fp = open("/var/www/cgi-bin/hdf.txt","w+")
fp.write(lss)
fp.close()
fpp = open("/var/www/cgi-bin/hdf.txt","r+")
for line in fpp:
	print line+"<br>"
