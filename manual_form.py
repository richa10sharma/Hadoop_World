...
print "here is the list of IPs of available system<br>"
commands.getstatusoutput("nmap -sP 192.168.43.117-255 -n | grep 'Nmap scan' | awk '{print $5}' > /etc/cluster/iplist.txt")
...
<form align ="right" action="http://192.168.43.102/cgi-bin/manual.py" method="post">
<br>
NAMENODE_IP : <input name='nip'  type='text' /><br>
NAMENODE_folder : <input name='nfol' type='text'><br>
JOBTRACKER_IP : <input name='jip' type='text' /><br>
<hr>
DN 1: <input name='d1ip'  type='text' /> &nbsp&nbsp D1fol: <input name='d1fol'  type='text' /><br>
DN 2: <input name='d2ip'  type='text' /> &nbsp&nbsp D2fol: <input name='d2fol'  type='text' /><br>
DN 3: <input name='d3ip'  type='text' /> &nbsp&nbsp D3fol: <input name='d3fol'  type='text' /><br>
DN 4: <input name='d4ip'  type='text' /> &nbsp&nbsp D4fol: <input name='d4fol'  type='text' /><br><hr>
TT 1: <input name='t1ip'  type='text' />&nbsp&nbsp&nbsp&nbsp
TT 2: <input name='t2ip'  type='text' /><br>
TT 3: <input name='t3ip'  type='text' />&nbsp&nbsp&nbsp&nbsp
TT 4: <input name='t4ip'  type='text' /><br>
