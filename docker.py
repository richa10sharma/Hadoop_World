...
#---------------MAKING NAMENODE----------------
print "making namenode at 172.17.0.2\n <br>"
commands.getstatusoutput("sudo docker run -it -d --name nn 2fbe481c02a4")
commands.getstatusoutput("sudo docker exec -i  nn hadoop namenode -format")
print commands.getstatusoutput("sudo docker exec -i  nn hadoop-daemon.sh start namenode")
print commands.getstatusoutput("sudo docker exec -i  nn /usr/java/jdk1.7.0_51/bin/jps")
print "<br><hr><br>"

#----------------MAKING JOBTRACKER---------------

print "making jobtracker at 172.17.0.3\n <br>"
commands.getstatusoutput("sudo docker run -it -d --name jt 9f38f9e67e6a")
print commands.getstatusoutput("sudo docker exec -i  jt hadoop-daemon.sh start jobtracker")
print "<br>"
print commands.getstatusoutput("sudo docker exec -i  jt /usr/java/jdk1.7.0_51/bin/jps")
print "<br><hr><br>"
#print "enter the number of datanodes and tasktrackers you want"
#n=raw_input()
...
while (i < int(n)):
	commands.getstatusoutput("sudo docker run -i -d --name dntt"+str(i)+" d5da31e978f6")
	a=commands.getstatusoutput('sudo docker inspect dntt'+str(i)+' | grep "IPAddress" | awk "{print $2}" | cut -d " " -f10 | cut -d "\n" -f1 ')[1]
	#print a[7:17]
	ip = a[7:17]
	print "making datanode at "+ip
	print "<br>"
	commands.getstatusoutput("sudo docker exec -i dntt"+str(i)+" hadoop-daemon.sh start datanode")
	print "making tasktracker at "+ip
	print "<br>"
	commands.getstatusoutput("sudo docker exec -i dntt"+str(i)+" hadoop-daemon.sh start tasktracker")
	print commands.getstatusoutput("sudo docker exec -i  dntt"+str(i)+" /usr/java/jdk1.7.0_51/bin/jps")
	print "<br><hr><br>"
	i=i+1
...
print """
		...
		<li><a href="dochdfs.py">ViewHDFS</a></li>
