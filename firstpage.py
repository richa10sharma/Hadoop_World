    ...
    <body>
        ...
        <div id="header">
            ...
            <ul>
                ...
                <li><a href="firstpage.py"><img id="home" src="http://127.0.0.1/homee.png" /></a></li>
		...
		<li href="#"><a href="#">Contact</a></li>
                <li><a title="Twitter" href="https://www.google.co.in/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwjI7q-s6c_NAhUlSY8KHaZLC_YQFggmMAA&url=https%3A%2F%2Ftwitter.com%2F%3Flang%3Den&usg=AFQjCNEC1-VaUkNHL90ZFoJUbNqV_YWc6w" target="_blank"><img id="tweet" src="http://127.0.0.1/tweety2.png" /></a></li>

                <li><a title="Facebook" href="https://www.facebook.com/" target="_blank"><img id="fbt" src="http://127.0.0.1/fbt.png" /></a></li>
        ...
        <a id="downd" href="#footer"><img  title="Down" class="downe" src="http://127.0.0.1/arrow-down.png" /></a>

        <br><br>

   <div id="intro">A website that lets you create your own Hadoop Cluster within a click</div>
...
print """
        ...
        <div class="imgdivs" id="imgdiv">

            <img src="http://127.0.0.1/cod1.jpg" />

            <p id="imgpara"></ul><b>MANUAL SETUP</b></ul><br>From the given IPs configure the cluster as you wish</p>

        </div>"""

print """
        <div class='imgdivs' id='imgdiv2'>

            <img src="http://127.0.0.1/keybo.jpg" />

            <p><b>AUTOMATIC SETUP</b><br>Automatically sets up an Optimized cluster </p>

        </div>

        <div class="imgdivs" id="imgdiv3">

            <img src="http://127.0.0.1/codeit.jpg" />

            <p><b>ON DEMAND SETUP</b><br>Sets Up an optimized cluster according to demand</p>
        ...
        <table>
          ...
          <thead>
              ...
              <tr>
                 ...
                 <th>Why use Hadoop ?</th>

                  <th>Immeasurable Ease..</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Allows for Distributed processing of large data sets across cluster of computers using simple programming models</td>

                <td id="td2">An ideal platform for implementing pre-processing efficiently and in a distributed manner over large datasets</td>
